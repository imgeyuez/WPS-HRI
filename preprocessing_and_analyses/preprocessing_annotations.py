    ...
    for dirpath, dirnames, filenames in os.walk(root_folder):
        for fname in filenames:
            if fname.endswith(".tsv") and "CURATION_USER" in fname:
                ...
                parsed["filename"] = os.path.relpath(fpath, root_folder)
                output.append(parsed)

    return output

# base directory and output file; change these for LLM/RoBERTa annotations
base_dir = "../data/curation_backup_2025_03_20/curation"
output_file = "manual_character_annotations.json"
